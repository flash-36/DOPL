...
def process_a():
    ...
    P[:, :, 0] = [
        ...
        [0.30, 0.62, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01],
        [0.01, 0.30, 0.62, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01],
        [0.01, 0.01, 0.30, 0.62, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01],
        [0.01, 0.01, 0.01, 0.30, 0.62, 0.01, 0.01, 0.01, 0.01, 0.01],
        [0.01, 0.01, 0.01, 0.01, 0.30, 0.62, 0.01, 0.01, 0.01, 0.01],
        [0.01, 0.01, 0.01, 0.01, 0.01, 0.30, 0.62, 0.01, 0.01, 0.01],
        [0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.30, 0.62, 0.01, 0.01],
        [0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.30, 0.62, 0.01],
        [0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.30, 0.62],
    ]  # Action 0
    P[:, :, 1] = [
...
def process_b():
    ...
    P[:, :, 0] = [
        [0.91, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01],
        [0.60, 0.32, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01],
        [0.01, 0.60, 0.32, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01],
        [0.01, 0.01, 0.60, 0.32, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01],
        [0.01, 0.01, 0.01, 0.60, 0.32, 0.01, 0.01, 0.01, 0.01, 0.01],
        [0.01, 0.01, 0.01, 0.01, 0.60, 0.32, 0.01, 0.01, 0.01, 0.01],
        [0.01, 0.01, 0.01, 0.01, 0.01, 0.60, 0.32, 0.01, 0.01, 0.01],
        [0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.60, 0.32, 0.01, 0.01],
        [0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.60, 0.32, 0.01],
        [0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.60, 0.32],
    ]  # Action 0
    ...
    R = np.zeros((n_states, n_actions))
    for state_index in range(n_states):
        R[state_index, :] = state_index / n_states
    # print(P)
    # print(R)
    return P, R
...
def save_matrices(P, R, arm_type):
    np.save(f"two_process_big_{arm_type}_transitions.npy", P)
    np.save(f"two_process_big_{arm_type}_rewards.npy", R)
