...
@register_training_function("gast")
def train(env, cfg):
    ...
    for k in tqdm(range(K)):
        ...
        for t in range(env.H):
            ...
            metrics["leader_set_error_gast"].append(set_difference_size)
            s_list = s_dash_list
        ...
        )  #  2 means opposite, 1 means no correlation, 0 means same order
